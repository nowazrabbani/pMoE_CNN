...
from wideresnet_moe_bin import WideResnet
...
for s in [25000]:
    ...
    for i in range(5):
        ...
        f='test_acc_loss_celeba_smiling_spurious_wideresnet_moe_s_'+str(s//1000)+'k_v'+str(i+1)
        
        np.save(f,z)
        
        t = weights_dict[49]
        
        f='model_params_celeba_smiling_spurious_wideresnet_moe_s_'+str(s//1000)+'k_v'+str(i+1)
