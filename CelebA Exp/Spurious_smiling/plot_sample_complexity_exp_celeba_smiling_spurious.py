...
f='test_acc_loss_celeba_smiling_spurious_wideresnet'
f_moe='test_acc_loss_celeba_smiling_spurious_wideresnet_moe'
no_sample_points=5
points=[5000, 10000, 15000, 20000, 25000]
no_v=5
last_epoch=50
...
plt.axhline(y=wideresnet_av_s[no_sample_points-1,1],c='k',ls='--',lw=1.5)
plt.axvline(x=20000,c='k',ls=':',lw=4)
plt.axvline(x=25000,c='k',ls=':',lw=4)
plt.legend(loc='lower center',ncol=1,prop={'size': 50},frameon=False)
