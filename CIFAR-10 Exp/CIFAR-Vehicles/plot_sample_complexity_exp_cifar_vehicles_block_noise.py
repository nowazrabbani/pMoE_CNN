...
f='test_acc_loss_cifar_vehicles_block_noise_wideresnet'
f_moe='test_acc_loss_cifar_vehicles_block_noise_wideresnet_moe'
no_sample_points=5
points=[4000, 8000, 12000, 16000, 20000]
no_v=5
last_epoch=50
...
plt.title('CIFAR-Vehicles-Block-Noise: Wideresnet vs. Wideresnet-MoE')
plt.show()
