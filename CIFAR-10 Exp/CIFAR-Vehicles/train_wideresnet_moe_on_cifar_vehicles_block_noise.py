...
for s in [4000, 8000, 12000, 16000, 20000]:
    ...
    for i in range(5):
        ...
        f='test_acc_loss_cifar_vehicles_block_noise_wideresnet_moe_s_'+str(s//1000)+'k_v'+str(i+1)
        
        np.save(f,z)
        
        t = weights_dict[49]
        
        f='model_params_cifar_vehicles_block_noise_wideresnet_moe_s_'+str(s//1000)+'k_v'+str(i+1)
